...
$message    = "Draw Has been Run To redo Hit Reset code is ".$no;
...
echo "<script>alert('Success All Draws has been Executed!') </script>";
echo "<script>location.replace('winners.php')</script>";
?>